...
const titlesAndContent: TitleContentData = [
  ...
  {
    title: {
      en: "2.1 The Data Protection Officer can be contacted in writing at the following addresses:, technical@selovisualstudio.com",
      pt: "",
    },
    content: {
      en: [
  ...
  },
  {
    ...
    content: {
      en: [
        ...
        ● collected for specified, legitimate and explicit purposes and never further
        processed in a way incompatible with those purposes;
        ● accurate and, as required, kept up to date, while providing for appropriate
        measures to ensure the deletion and rectification of incomplete or inaccurate data, taking into account the purposes for which they were collected or for which they are further processed;
  ...
  },
  {
    ...
    content: {
      en: [
        ...
        ● Comply with legal or regulatory requirements, necessary for the validity of certificates for some
        of the services offered, such as training initiatives;
